...
<div class="row my-4">
    <div class="col-12">
        <div class="card border-0 shadow-sm rounded-3">
            ...
            <div class="card-body">
                <form action="{{ route('admin.pengumuman.update', $pengumuman->id) }}" method="POST" id="formPengumuman" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <hr>
                    @if($pengumuman->dokumentasi->count())
                        <label class="form-label mt-3">Dokumentasi Lama</label>

                        <div class="row g-2 mb-3">
                            @foreach($pengumuman->dokumentasi as $d)
                                <div class="col-md-3">
                                    <div class="position-relative border rounded p-2">
                                        ...
                                        <button type="button"
                                                ...
                                                onclick="deleteOldImage({{ $d->id }}, this)">
                                            ✕
                                        </button>
...
<script>
    ...
    function deleteOldImage(id, el) {
        deletedImages.push(id);
        document.getElementById('delete_images').value = JSON.stringify(deletedImages);
